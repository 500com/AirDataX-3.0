package com.alibaba.datax.plugin.writer.extxtwriter;
...
/**
 * Created by sunwq on 2017/8/7.
 */
public class ExtxtWriter extends Writer {
        ...
        private void validateParameter() {
            this.writerSliceConfig
                    .getNecessaryValue(
                            ...
                            ExtxtFileWriterErrorCode.REQUIRED_VALUE);
            ...
            try {
                ...
                if (dir.isFile()) {
                    throw DataXException
                            .asDataXException(
                                    ExtxtFileWriterErrorCode.ILLEGAL_VALUE,
                                    String.format(
                ...
                if (!dir.exists()) {
                    ...
                    if (!createdOk) {
                        throw DataXException
                                .asDataXException(
                                        ExtxtFileWriterErrorCode.CONFIG_INVALID_EXCEPTION,
                ...
                throw DataXException.asDataXException(
                        ExtxtFileWriterErrorCode.SECURITY_NOT_ENOUGH,
        ...
        public void prepare() {
            ...
            if ("truncate".equals(writeMode)) {
                ...
                try {
                    ...
                    throw DataXException
                            .asDataXException(
                                    ExtxtFileWriterErrorCode.Write_FILE_ERROR,
    ...
    public static class Task extends Writer.Task {
        ...
        public void startWrite(RecordReceiver lineReceiver) {
            ...
            try {
                ...
                throw DataXException.asDataXException(
                        ExtxtFileWriterErrorCode.Write_FILE_IO_ERROR,
